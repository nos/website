...
function (_React$Component) {
  ...
  function DownloadButton() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "DownloadUrl",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var downloadUrl, resp, assets;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              assets.forEach(function (asset) {
                if (downloadUrl.endsWith(".exe") && navigator.platform.indexOf('Win') !== -1 || downloadUrl.endsWith(".dmg") && navigator.platform.indexOf('Mac') !== -1 || downloadUrl.endsWith(".AppImage") && navigator.platform.indexOf('Linux') !== -1) {
                  _this.setState({
...
//# sourceMappingURL=index.js.12cd5c19b6527ece60da.hot-update.js.map