          ...
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              assets.forEach(function (asset) {
                if (asset.endsWith(".exe") && navigator.platform.indexOf('Win') !== -1 || asset.endsWith(".dmg") && navigator.platform.indexOf('Mac') !== -1 || asset.endsWith(".AppImage") && navigator.platform.indexOf('Linux') !== -1) {
                  _this.setState({
...
//# sourceMappingURL=index.js.918c88697cd14a7b31f1.hot-update.js.map